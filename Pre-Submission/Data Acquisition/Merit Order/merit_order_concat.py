...
df1 = pd.read_csv("2023_1.csv")
df2 = pd.read_csv("2023_2.csv")
df3 = pd.read_csv("2023_3.csv")
df4 = pd.read_csv("2023_4.csv")
df5 = pd.read_csv("2023_5.csv")
df6 = pd.read_csv("2023_6.csv")
